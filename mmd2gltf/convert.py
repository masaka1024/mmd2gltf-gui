            ...
            if bake_physics:
                ...
                if _phys.get("rigidBodies"):
                    ...
                    hair_keys, hair_tkeys, _n_excl = bake_hair_into_gltf(
                        ...
                        rigid_chain_gravity_power=rigid_chain_gravity_power,
                        rigid_chain_stiffness_force=rigid_chain_stiffness_force,
                        rigid_body_gravity=rigid_body_gravity,
                        rigid_body_linear_damping=rigid_body_linear_damping,
                        rigid_body_angular_damping=rigid_body_angular_damping,
                        rigid_body_warmup_seconds=rigid_body_warmup_seconds,
                        rigid_body_iterations=rigid_body_iterations,
                        rigid_body_prime_full_motion=rigid_body_prime_full_motion,
                        rigid_body_self_collision_scale=rigid_body_self_collision_scale,
                        rigid_body_max_linear_speed=rigid_body_max_linear_speed,
                        rigid_body_max_angular_speed=rigid_body_max_angular_speed,
                        rigid_body_substeps=rigid_body_substeps,
                        segment_aware_collision=segment_aware_collision,
                        skirt_bone_twist=skirt_bone_twist)
